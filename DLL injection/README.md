...
This repository contains a POC for the DLL injection attack. In the attack, the attacker create a DLL file containing malicious code, and make another process in the OS to run this DLL by injecting the DLL path to the process memory. Therefore, the process will execute the malicious code from the DLL, and some serious damage can be caused - based on the DLL code.
